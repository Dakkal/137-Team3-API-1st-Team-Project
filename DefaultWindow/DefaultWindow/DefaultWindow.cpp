                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (true)
    {
		// PeekMessage : 메세지를 메세지를 읽어오면 true, 메세지가 없을 경우 false를 리턴
		
		// PM_REMOVE : 메세지 큐에서 메세지를 읽어옴과 동시에 메세지 큐에서 제거
...
{	
   ...
   // AdjustWindowRect : 출력 영역을 조절하는 함수

   // 최종적인 창 크기 rc = 본래 rc + 기본 윈도우 창 스타일 + 메뉴바 크기 고려 여부
